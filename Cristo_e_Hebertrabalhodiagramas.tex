...
Uma boa modelagem é essencial para a construção de um sistema bem pensado, facilitando a visualização dos sistemas. Para auxiliar o processo de modelagem, a UML possui uma miríade de diagramas diferentes que representam partes específicas do todo. Os desenvolvedores devem saber utilizar cada tipo de diagrama(os que foram apresentados neste trabalho e os muitos outros diagramas existentes)visando assim, a construção de um excelente sistema de informação.
